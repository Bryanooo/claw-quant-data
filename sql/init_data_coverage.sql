-- Data-partition coverage audits and their independent durable queue.
CREATE TABLE IF NOT EXISTS sys_data_coverage_job (
    ...
    CONSTRAINT ck_data_coverage_job_range
...
CREATE TABLE IF NOT EXISTS sys_data_coverage_audit (
    ...
    partial_partitions    INTEGER NOT NULL DEFAULT 0,
    coverage_ratio        NUMERIC(8, 6),
    status                VARCHAR(24) NOT NULL,
    evidence              JSONB NOT NULL DEFAULT '{}'::jsonb,
    started_at            TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    finished_at           TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT ck_data_coverage_audit_range
        CHECK (start_date <= end_date),
...
CREATE TABLE IF NOT EXISTS sys_data_coverage_partition (
    ...
    entity_count      BIGINT,
    expected_entity_count BIGINT,
    entity_coverage_ratio NUMERIC(10, 6),
