...
- 功能：获取美股交易日历信息
- PostgreSQL 表：`tushare_norm_us_tradecal`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=us_tradecal`）
- REST：`GET /api/v1/data/datasets/us_tradecal/records`
- 接口 REST：`GET /api/v1/data/interfaces/us_tradecal/records`
...
| `is_open` | `int` | `BIGINT` | 是否交易 '0'休市 '1'交易 |
