...
- 功能：国债实际收益率曲线利率
- PostgreSQL 表：`tushare_norm_us_trycr`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=us_trycr`）
- REST：`GET /api/v1/data/datasets/us_trycr/records`
- 接口 REST：`GET /api/v1/data/interfaces/us_trycr/records`
