...
logger = logging.getLogger("collector.ccass_hold_detail")

_FIELDS = ["trade_date", "ts_code", "name", "col_participant_id",
           "col_participant_name", "col_shareholding", "col_shareholding_percent"]
_PK = ["ts_code", "trade_date", "col_participant_id"]


class CcassHoldDetailCollector:
    INTERFACE_NAME = "ccass_hold_detail"
    ...
    def fetch(self, **params):
        return self.pro.ccass_hold_detail(**params)
    ...
    def collect_all_history(self, start_date="20200101", end_date="20260513"):
        ...
        while d <= e:
            ...
            d += timedelta(days=1)
            time.sleep(0.3)
        logger.info(f"✅ ccass_hold_detail: 历史补齐 {total} 行")
        return total
