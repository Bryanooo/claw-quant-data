...
- 官方文档：[doc 123](https://tushare.pro/document/2?doc_id=123)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/basic/new_share.py:NewShareCollector](../../../collectors/stock/basic/new_share.py)
