...
- PostgreSQL 表：`tushare_norm_fund_adj`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=fund_adj`）
- REST：`GET /api/v1/data/datasets/fund_adj/records`
- 接口 REST：`GET /api/v1/data/interfaces/fund_adj/records`
