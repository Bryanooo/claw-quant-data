...
- 分类：股票数据/资金流向数据
- 功能：获取东方财富板块资金流向，每天盘后更新
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：6000积分可以调取，具体请参阅 积分获取办法
- 官方文档：[doc 344](https://tushare.pro/document/2?doc_id=344)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/moneyflow/moneyflow_ind_dc.py:MoneyflowIndDcCollector](../../../collectors/stock/moneyflow/moneyflow_ind_dc.py)
