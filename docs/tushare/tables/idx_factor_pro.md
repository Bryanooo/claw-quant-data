...
- PostgreSQL 表：`tushare_norm_idx_factor_pro`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=idx_factor_pro`）
- REST：`GET /api/v1/data/datasets/idx_factor_pro/records`
- 接口 REST：`GET /api/v1/data/interfaces/idx_factor_pro/records`
