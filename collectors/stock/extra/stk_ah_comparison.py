...
logger = logging.getLogger("collector.stk_ah_comparison")

_FIELDS = ["hk_code", "ts_code", "trade_date", "hk_name", "hk_pct_chg", "hk_close",
           "name", "close", "pct_chg", "ah_comparison", "ah_premium"]
_PK = ["ts_code", "hk_code", "trade_date"]


class StkAhComparisonCollector:
    INTERFACE_NAME = "stk_ah_comparison"
    ...
    def fetch(self, **params):
        return self.pro.stk_ah_comparison(**params)
    ...
    def collect_all_history(self, start_date="20200101", end_date="20260513"):
        ...
        while d <= e:
            ...
            d += timedelta(days=1)
            time.sleep(0.3)
        logger.info(f"✅ stk_ah_comparison: 历史补齐 {total} 行")
        return total
