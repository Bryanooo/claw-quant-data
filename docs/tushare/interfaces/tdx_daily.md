...
- 分类：股票数据/打板专题数据
- 功能：获取各板块行情，包括成交和估值等数据
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：用户积累6000积分可调取，具体请参阅 积分获取办法
- 官方文档：[doc 378](https://tushare.pro/document/2?doc_id=378)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/board/tdx_daily.py:TdxDailyCollector](../../../collectors/stock/board/tdx_daily.py)
