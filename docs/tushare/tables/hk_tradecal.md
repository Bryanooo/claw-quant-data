...
- 功能：获取交易日历
- PostgreSQL 表：`tushare_norm_hk_tradecal`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=hk_tradecal`）
- REST：`GET /api/v1/data/datasets/hk_tradecal/records`
- 接口 REST：`GET /api/v1/data/interfaces/hk_tradecal/records`
