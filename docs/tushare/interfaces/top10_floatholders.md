...
- 官方文档：[doc 62](https://tushare.pro/document/2?doc_id=62)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/reference/top10_floatholders.py](../../../collectors/stock/reference/top10_floatholders.py)、[collectors/stock/reference/top10_floatholders.py:Top10FloatholdersCollector](../../../collectors/stock/reference/top10_floatholders.py)
