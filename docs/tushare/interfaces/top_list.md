...
- 分类：股票数据/打板专题数据
- 功能：龙虎榜每日交易明细 数据历史： 2005年至今
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：用户需要至少2000积分才可以调取，具体请参阅 积分获取办法
- 官方文档：[doc 106](https://tushare.pro/document/2?doc_id=106)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/board/top_list.py:TopListCollector](../../../collectors/stock/board/top_list.py)
