...
- 功能：Hibor利率
- PostgreSQL 表：`tushare_norm_hibor`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=hibor`）
- REST：`GET /api/v1/data/datasets/hibor/records`
- 接口 REST：`GET /api/v1/data/interfaces/hibor/records`
