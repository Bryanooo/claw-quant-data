...
- 官方文档：[doc 356](https://tushare.pro/document/2?doc_id=356)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/board/limit_step.py:LimitStepCollector](../../../collectors/stock/board/limit_step.py)
