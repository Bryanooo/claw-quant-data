...
- PostgreSQL 表：`tushare_norm_rt_hk_k`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=rt_hk_k`）
- REST：`GET /api/v1/data/datasets/rt_hk_k/records`
- 接口 REST：`GET /api/v1/data/interfaces/rt_hk_k/records`
