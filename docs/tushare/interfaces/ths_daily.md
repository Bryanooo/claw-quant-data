...
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：官方页面未单独声明
- 官方文档：[doc 260](https://tushare.pro/document/2?doc_id=260)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/index/ths_daily.py:ThsDailyCollector](../../../collectors/index/ths_daily.py)、[collectors/stock/board/ths_daily.py:ThsDailyCollector](../../../collectors/stock/board/ths_daily.py)
