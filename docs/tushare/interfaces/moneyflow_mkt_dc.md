...
- 分类：股票数据/资金流向数据
- 功能：获取东方财富大盘资金流向数据，每日盘后更新
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：120积分可试用，6000积分可正式调取，具体请参阅 积分获取办法
- 官方文档：[doc 345](https://tushare.pro/document/2?doc_id=345)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/moneyflow/moneyflow_mkt_dc.py:MoneyflowMktDcCollector](../../../collectors/stock/moneyflow/moneyflow_mkt_dc.py)
