...
- 分类：股票数据/参考数据
- 功能：获取上市公司前十大股东数据，包括持有数量和比例等信息
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：需2000积分以上才可以调取本接口，5000积分以上频次会更高
- 官方文档：[doc 61](https://tushare.pro/document/2?doc_id=61)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/reference/top10_holders.py](../../../collectors/stock/reference/top10_holders.py)、[collectors/stock/reference/top10_holders.py:Top10HoldersCollector](../../../collectors/stock/reference/top10_holders.py)
