...
- 官方文档：[doc 359](https://tushare.pro/document/2?doc_id=359)
...
强类型标准表 `tushare_norm_fund_factor_pro`。标准表字段、类型、日期列、系统血缘字段和
稳定性规则见[标准化表契约](../tables/fund_factor_pro.md)。转换失败记录进入
