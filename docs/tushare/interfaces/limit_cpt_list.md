...
- 官方文档：[doc 357](https://tushare.pro/document/2?doc_id=357)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/board/limit_cpt_list.py:LimitCptListCollector](../../../collectors/stock/board/limit_cpt_list.py)
