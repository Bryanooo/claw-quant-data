...
- 分类：股票数据/参考数据
- 功能：根据证券交易所交易规则的有关规定，交易所每日发布股票交易异常波动情况
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：需要6000积分可以调取，具体请参阅 积分获取办法
- 官方文档：[doc 451](https://tushare.pro/document/2?doc_id=451)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/reference/stk_shock.py](../../../collectors/stock/reference/stk_shock.py)、[collectors/stock/reference/stk_shock.py:StkShockCollector](../../../collectors/stock/reference/stk_shock.py)
