...
- 功能：获取美国每日国债收益率曲线利率
- PostgreSQL 表：`tushare_norm_us_tycr`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=us_tycr`）
- REST：`GET /api/v1/data/datasets/us_tycr/records`
- 接口 REST：`GET /api/v1/data/interfaces/us_tycr/records`
...
|---|---|---|---|
| `date` | `str` | `DATE` | 日期 |
| `m1` | `float` | `NUMERIC` | 1月期 |
| `m2` | `float` | `NUMERIC` | 2月期 |
| `m3` | `float` | `NUMERIC` | 3月期 |
| `m4` | `float` | `NUMERIC` | 4月期（数据从20221019开始） |
| `m6` | `float` | `NUMERIC` | 6月期 |
| `y1` | `float` | `NUMERIC` | 1年期 |
| `y2` | `float` | `NUMERIC` | 2年期 |
| `y3` | `float` | `NUMERIC` | 3年期 |
| `y5` | `float` | `NUMERIC` | 5年期 |
| `y7` | `float` | `NUMERIC` | 7年期 |
| `y10` | `float` | `NUMERIC` | 10年期 |
| `y20` | `float` | `NUMERIC` | 20年期 |
| `y30` | `float` | `NUMERIC` | 30年期 |
