...
- PostgreSQL 表：`tushare_norm_fund_daily`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=fund_daily`）
- REST：`GET /api/v1/data/datasets/fund_daily/records`
- 接口 REST：`GET /api/v1/data/interfaces/fund_daily/records`
