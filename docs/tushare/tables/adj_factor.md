...
- PostgreSQL 表：`tushare_norm_adj_factor`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=adj_factor`）
- REST：`GET /api/v1/data/datasets/adj_factor/records`
- 接口 REST：`GET /api/v1/data/interfaces/adj_factor/records`
