...
- 分类：股票数据/参考数据
- 功能：获取上市公司增减持数据，了解重要股东近期及历史上的股份增减变化
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：用户需要至少2000积分才可以调取。基础积分有流量控制，积分越多权限越大，5000积分以上无明显限制，请自行提高积分，具体请参阅 积分获取办法
- 官方文档：[doc 175](https://tushare.pro/document/2?doc_id=175)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/reference/stk_holdertrade.py:StkHoldertradeCollector](../../../collectors/stock/reference/stk_holdertrade.py)
