...
- 功能：大宗交易
- Token 权限：**有权限**（接口返回成功）
- 官方权限要求：2000积分可调取，每分钟内限制次数，超过5000积分频次相对较高，具体请参阅 积分获取办法
- 官方文档：[doc 161](https://tushare.pro/document/2?doc_id=161)
- HTTP：`POST http://api.tushare.pro`
- claw-quant：已实现；代码：[collectors/stock/reference/block_trade.py:BlockTradeCollector](../../../collectors/stock/reference/block_trade.py)
