...
- 功能：转融通转融券交易汇总
- PostgreSQL 表：`tushare_norm_slb_sec`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=slb_sec`）
- REST：`GET /api/v1/data/datasets/slb_sec/records`
- 接口 REST：`GET /api/v1/data/interfaces/slb_sec/records`
