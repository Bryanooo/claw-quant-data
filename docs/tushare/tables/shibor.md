...
- 功能：shibor利率
- PostgreSQL 表：`tushare_norm_shibor`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=shibor`）
- REST：`GET /api/v1/data/datasets/shibor/records`
- 接口 REST：`GET /api/v1/data/interfaces/shibor/records`
