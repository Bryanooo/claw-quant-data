...
- 功能：获取期权日线行情
- PostgreSQL 表：`tushare_norm_opt_daily`
- 契约版本：`1`
...
- 原始数据表：`tushare_raw_record`（`api_name=opt_daily`）
- REST：`GET /api/v1/data/datasets/opt_daily/records`
- 接口 REST：`GET /api/v1/data/interfaces/opt_daily/records`
